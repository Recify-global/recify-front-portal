...
export async function listInvoices(
  ...
  return apiRequest<Paginated<BackendInvoice>>(url);
}

export async function getInvoice(companyId: string, id: string): Promise<BackendInvoice> {
...
export async function deleteInvoice(companyId: string, id: string): Promise<void> {
